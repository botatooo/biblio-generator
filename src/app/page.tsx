...
export default function Home() {
  ...
  return (
    <div className="w-full max-w-full">
      <div className="py-2 px-4 mb-2 text-white text-center bg-teal-400 rounded-md">
        Voir le{" "}<a  className="underline" href="/fichiers/Guide_prés_travaux_écrits.pdf" target="_blank">Guide de présentation des travaux écrits</a>{" "} pour plus d&apos;information.
      </div>
